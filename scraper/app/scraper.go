...
import (
	...
	generated "github.com/mochahub/coinprice-scraper/data/psql/generated"
...
func ScrapeExchange(
	...
	for index := range pairs {
		pair := pairs[index]
		lastSync, err := generated.FindLastSync(ctx, db, pair.NormalizedBase, pair.NormalizedQuote, client.GetExchangeIdentifier())
